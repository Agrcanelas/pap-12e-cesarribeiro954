...
$t = [
    'pt' => [
        ...
        'slider2' => 'Promoções especiais para si',
    ...
    'en' => [
        'slider1' => 'Quality eco-friendly parts',
        'slider2' => 'Special offers for you',
...
.about-box {
    ...
    border-radius:18px;
    box-shadow:0 0 15px rgba(255,255,255,0.4), 0 10px 25px rgba(0,0,0,0.15);
    transition:.4s;
}
.about-box:hover {
    transform:translateY(-6px);
    box-shadow:0 0 25px rgba(255,255,255,0.9), 0 15px 35px rgba(0,0,0,0.25);
}
.about-text { max-width:65%; }
.about-text h2 { color:#2e7d32; margin-bottom:10px; }
.about-text p { font-size:16px; line-height:1.6; color:#333; }
.about-logo img { max-width:140px; }

@media(max-width:768px){
    .about-box { flex-direction:column; text-align:center; gap:20px; }
