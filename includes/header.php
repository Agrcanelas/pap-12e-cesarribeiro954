...
<!-- FAVICON GLOBAL (para todas as páginas) -->
<link rel="icon" href="https://img.freepik.com/vetores-premium/carro-ecologico-e-vetor-de-logotipo-de-icone-de-tecnologia-de-carro-verde-eletrico_661040-245.jpg?v=1" type="image/png">
...
<header id="mainHeader" style="background:#2e7d32; padding:15px 30px; display:flex; align-items:center; justify-content:space-between; box-shadow:0 4px 10px rgba(0,0,0,0.1); border-radius:10px; flex-wrap:wrap; gap:10px;">
    ...
    <div style="display:flex; align-items:center; gap:20px; flex-wrap:wrap;">
        ...
        <nav class="menu" style="display:flex; gap:25px; font-weight:bold; align-items:center; position:relative;">
            <a href="/pap-12e-cesarribeiro954/index.php" style="color:#fff; text-decoration:none; <?= ($current_page=='index.php'?'text-decoration:underline;':'') ?>">
                <i class="fa fa-home"></i> <?= $translations[$lang]['home'] ?>
            </a>

            <a href="/pap-12e-cesarribeiro954/cart.php" style="color:#fff; text-decoration:none;">
                <i class="fa fa-shopping-cart"></i> <?= $translations[$lang]['cart'] ?>
            </a>

            <a href="/pap-12e-cesarribeiro954/ofertas.php" style="color:#fff; text-decoration:none;">
        ...
        <form method="get" style="margin:0; display:flex; gap:8px;">
            <button type="submit" name="lang" value="pt" style="background:none; border:none; cursor:pointer;">
                <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Portugal.svg" style="width:28px; height:18px;">
            </button>
            <button type="submit" name="lang" value="en" style="background:none; border:none; cursor:pointer;">
                <img src="https://upload.wikimedia.org/wikipedia/en/a/ae/Flag_of_the_United_Kingdom.svg" style="width:28px; height:18px;">
            </button>
        </form>
        ...
        <div class="user-menu">
            <?php if($user_logged_in): ?>
                ...
                <a href="/pap-12e-cesarribeiro954/auth/logout.php" style="color:#fff; font-weight:bold; text-decoration:none;">
                    <i class="fa fa-sign-out-alt"></i> <?= $translations[$lang]['logout'] ?>
                </a>
            <?php else: ?>
                <a href="/pap-12e-cesarribeiro954/auth/login.php" style="color:#fff; font-weight:bold; text-decoration:none;">
